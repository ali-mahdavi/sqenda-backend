package com.electropeyk.authservice.config.mongodb.changelogs;


import com.electropeyk.authservice.domain.AuthClientDetails;
import com.electropeyk.authservice.domain.User;
import com.electropeyk.authservice.enums.Authorities;
